  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'We serve San Jose, CA and surrounding Bay Area communities. Contact us to confirm if we service your specific area. We offer free in-home consultations and professional installation services throughout the San Jose area.'
        },
        {
          question: 'Do you offer in-home consultations?',
          answer: 'Absolutely! We offer free in-home consultations where our installation experts will visit your home with samples, take measurements, and provide expert advice. This allows you to see how different flooring options look in your actual space with your lighting and décor.'
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Yes! We offer a Room Visualizer tool that allows you to upload a photo of your room and see how different flooring options would look. You can also schedule a free in-home consultation where we bring samples to your home so you can see them in your actual space.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Yes! We regularly offer promotions and special deals on flooring installation services. Check our website or contact us to learn about current offers and seasonal discounts.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Care instructions vary by flooring type. We provide detailed care and maintenance guides with every installation. Generally, regular sweeping/vacuuming and occasional mopping with appropriate cleaners will keep your floors looking beautiful.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Most product warranties are transferable to new homeowners, which can add value to your home. Installation warranties typically apply to the original customer. Specific terms will be outlined in your warranty documentation.'
        }
      ]
    }
  ];

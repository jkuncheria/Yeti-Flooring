  ...
  const financingOptions = [
    {
      ...
      description: 'Get up to 18 months of interest-free financing on qualifying projects. No interest if paid in full within the promotional period.',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            available on qualifying projects. No down payment required.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive an instant credit decision. Most applicants are approved immediately and can start their project right away.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-900 text-white rounded-full w-16 h-16 flex items-center justify-center text-2xl font-bold mx-auto mb-6">
              ...
              <p className="text-gray-600">
                Once approved, you can use your credit line to finance your flooring materials and installation services immediately.
              </p>
            </div>
          </div>
        </div>
